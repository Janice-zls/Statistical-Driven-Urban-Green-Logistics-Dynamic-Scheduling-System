...
def solve():
    ...
    for n in nodes_data:
        ...
        # Split into chunks of max 3000 weight and 13.5 volume
    ...
    # This leads to a more realistic fleet mix and ~60k cost.
    ...
    while unserved:
        ...
        # Vehicles can do multiple trips, so we do not strictly limit them.
        for v in [4, 1, 5, 2, 3]:
