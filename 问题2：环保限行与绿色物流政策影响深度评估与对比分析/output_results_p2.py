...
import sys
sys.path.append('问题2')
from solve_p2 import load_data, VEHICLES, eval_edge, get_speed     

def main():
    nodes, dist_mat = load_data()
    with open('问题2/solution_opt.json', 'r', encoding='utf-8') as f:
        sol = json.load(f)
    ...
    df.to_excel('问题2/车辆调度方案.xlsx', index=False)
    print("Results saved to 问题2/车辆调度方案.xlsx")
